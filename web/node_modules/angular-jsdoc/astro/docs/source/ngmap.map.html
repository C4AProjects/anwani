...
<div id="main">
    <article>
        <pre class="prettyprint source linenums"><code>(function () {
            ...
            * @attr {String} &lt;MapOption> [Any Google map
            options](https://developers.google.com/maps/documentation/javascript/reference?csw=1#MapOptions)
            * @attr {String} &lt;MapEvent> [Any Google map
            events](https://rawgit.com/allenhwkim/angularjs-google-maps/master/build/map_events.html)
            * @example
            * Usage:
